            ...
            <div class="container  ">
                ...
                <h4 class="title-hny mb-3">Características</h4>
                    <div class="row about-w3pvt-top mt-2">
                        ...
                        <div class="col-lg-6 about-info">
                            <hr>
                        <p  class="text-center">  <iframe  width="500" height="285" src="https://www.youtube.com/embed/sn7K0xhiNSk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </p>
                            <hr>
                           
                            <strong>Pixels-to-Points</strong> para creación de nubes de puntos fotogramétricos a
                                partir de una matriz de imágenes. <br>
