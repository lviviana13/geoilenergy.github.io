        ...
        <div class="container py-md-5 py-3">
            <div class="px-lg-5">
                ...
                <p class="mt-5 pr-lg-5">
                    Por favor, escribanos si tiene alguna pregunta o solicitud sobre nuestro software y/o servicios. <br>
                    Responderemos a su mensaje en un lapso de 24 horas
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="w3lName">Nombre y Apellidos</label>
                                    <input type="text" name="w3lName" id="w3lName">
                                </div>
                                <div class="form-group">
                                    <label for="w3lSender">Correo electrónico</label>
                                    <input type="text" name="w3lSender" id="w3lSender">
                                </div>
                                <div class="form-group">
                                    <label for="w3lSubject"> Asunto</label>
                                    <input type="text" name="w3lSubject" id="w3lSubject">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="w3lSubject">Mensaje</label>
                                    <textarea name="w3lMessage" id="w3lMessage"> </textarea>
                                </div>
                            </div>
                            <div class="form-group mx-auto mt-3">
                                <button type="submit" class="btn btn-default morebtn more black con-submit">Enviar</button>
                            </div>
                        </div>
