        ...
        <div class="container py-3">
            <div class="content-sing-w3pvt px-lg-5">
                ...
                <p>Geomodeling Technology Corp. es una compañía con base en Calgary, Canadá, líder en programas de
                    ...
                    incrementar los beneficios de las compañías de petróleo reduciendo los costos con soluciones de
                    software y servicios que mejoren la caracterización y recobro en sus reservorios.</p>
                ...
                <div class="row about-w3pvt-top mt-2">
                    ...
                    <div class="col-lg-6 about-info">
                        ...
                        <ul class="ul-lista">
                            ...
                            <li>Clasificación de facies sísmicas.</li>
                            <li>Herramientas avanzadas de Interpretación.</li>
                            <li>Descomposición espectral.</li>
                            <li>Interpretación para no convencionales.</li>
                ...
                <div class="row about-w3pvt-top mt-2">
                    <div class="col-lg-6 about-info">
                        ...
                        <ul class="ul-lista">
                            ...
                            <li>La información de geología y geofísica se encontrará integrada en una sola
                                plataforma fácil de usar para una mayor comunicación entre su equipo de
                                interpretación.
                            </li>
                            <li>No se requiere que los ingenieros de simulación ajusten las propiedades de geología
