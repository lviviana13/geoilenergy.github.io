    ...
    <div class="container py-md-5">
        ...
        <div class="row news-grids mt-md-5 mt-4 text-center">
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/g-calculator')}}"><img src="/images/software/index/geographiCalculator.png" alt="w3pvt" class="img-fluid">
                    <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/global-mapper')}}"><img src="/images/software/index/gm.png" alt="w3pvt" class="img-fluid">
                    <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/global-mapper-ld')}}"><img src="/images/software/index/gm-l.jpg" alt="w3pvt" class="img-fluid">
                    <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/fme')}}"><img style="height: 200px" src="/images/software/index/fme.png" alt="w3pvt" class="img-fluid">
                    <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/solv3d')}}"><img style="height: 200px" src="/images/software/index/solv3D.png" alt="w3pvt" class="img-fluid"></a>
                <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                <a href="{{url('/es/software/geosoluciones/i-open')}}"><img style="height: 200px" src="/images/software/index/iopen.svg" alt="w3pvt" class="img-fluid"></a>
                <div class="gal-info">
