    ...
    <section class="projects py-5" id="gallery">
        <div class="container py-md-5">
            ...
            <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/tesseral')}}"><img style="height: 100px"  src="/images/software/index/tesseral_logo.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
            ...
            <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/globe-claritas')}}"><img  style="height: 100px" src="/images/software/index/globe-claritas_logo.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/geomodeling')}}"><img style="height: 100px" src="/images/software/index/geomodeling.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/seisware-geologia')}}"><img style="height: 150px" src="/images/software/index/seisware_gl.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/seisware-geofisica')}}"><img style="height: 150px" src="/images/software/index/seisware_gf.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/qi')}}"><img style="height: 150px" src="/images/software/index/qi.PNG" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/structural-solver')}}"><img style="height: 150px" src="/images/software/index/structuresolver.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/hds2000')}}"><img style="height: 150px" src="/images/software/index/hds2000.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/es/software/geofisica/geovariances')}}"><img style="height: 150px" src="/images/software/index/geovariances.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
