    ...
    <section class="projects py-5" id="gallery">
        <div class="container py-md-5">
            ...
            <div class="col-md-4 gal-img">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/software/geofisica/geomodeling')}}"><img src="/images/software/index/geomodeling.jpg" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/software/geofisica/seisware-geologia')}}"><img src="/images/software/index/seisware_gl.jpg" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/software/geofisica/seisware-geofisica')}}"><img src="/images/software/index/seisware_gf.jpg" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/software/geofisica/structural-solver')}}"><img src="/images/software/index/structuresolver.jpg" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
                ...
                <div class="col-md-4 gal-img">
                    <a href="{{url('/software/geofisica/hds2000')}}"><img src="/images/software/index/hds2000.png" alt="w3pvt" class="img-fluid"></a>
                    <div class="gal-info">
