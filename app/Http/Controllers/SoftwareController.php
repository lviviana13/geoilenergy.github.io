...
{
    public function software($lenguaje, $idsoftware, $idsubsoftware = null)
    {
    ...
    protected function geosoluciones($idgeosolucion, $lenguaje)
    {
    ...
    protected function geofisica($idgeofisica, $lenguaje)
    {
