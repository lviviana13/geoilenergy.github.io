...
function formSend() {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire({
    ...
    if (isConfirm.value) {
      ...
      var csfr = document.getElementById('csfr').value;
      ...
      fetch('/contact', {
        ...
        if (respuesta.resp === 1) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Correcto', 'Se ha enviado el mensaje', 'success');
        } else {
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Oops', 'Ha ocurrido un error', 'error');
        }
...
module.exports = __webpack_require__(/*! E:\xampp\htdocs\geoilenergy.github.io\resources\js\contact.js */"./resources/js/contact.js");
